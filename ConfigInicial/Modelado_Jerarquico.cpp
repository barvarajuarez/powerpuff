...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Model PALMA
		model = glm::translate(modelTemp, glm::vec3(1.0f, 0.0f, 0.0f)); //NUEVA
		...
		modelTemp2 = modelTemp = model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.0f));
		model = glm::translate(model, glm::vec3(0.5f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 0.3f, 0.25f));
		color = glm::vec3(0.15f, 0.5f, 6);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Model dedo2 A
		model = glm::translate(modelTemp, glm::vec3(0.1f, 0.1f, 0.1f));
